...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //spinner
        ArrayAdapter<String> obj=new ArrayAdapter<String>(PostActivity.this, android.R.layout.simple_spinner_item,arr);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (videoUrl != null){
                    ...
                    dialog.dismiss();
                    Toast.makeText(PostActivity.this, "video must be selected!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void uploadVideo(String filePath) {
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(PostActivity.this, "Upload error: " + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
